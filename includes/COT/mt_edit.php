        ...
        <div class="container col-sm-8 my-4 bg-light ">
                <form action="processindicator.php" class="form-group sm" method="POST">
                    <input type="hidden" name="indicator_id" value="<?php echo $row['indicator_id']?>">
                        <legend class="legend-control bg-info text-white ">Update COT Indicator - Master Teacher</legend>
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div>
                                    <button type="submit" class="btn-sm btn-success my-4" name="mtupdate">Update</button>
                                    <input type="button" value="Cancel" class="btn-sm btn-danger my-4" onclick="window.location.href='mt_index.php'" />
                            </div>
                </form>
        </div>
</div>
